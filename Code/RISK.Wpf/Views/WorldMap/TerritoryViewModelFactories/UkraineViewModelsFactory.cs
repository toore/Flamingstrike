...
{
    public class UkraineViewModelsFactory : TerritoryViewModelsFactoryBase
    {
        public UkraineViewModelsFactory(ITerritoryColors territoryColors) : base(territoryColors) {}
