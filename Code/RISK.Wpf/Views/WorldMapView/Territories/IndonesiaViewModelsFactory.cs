...
{
    public class IndonesiaViewModelsFactory : TerritoryViewModelsFactoryBase
    {
        public IndonesiaViewModelsFactory(ITerritoryColors territoryColors) : base(territoryColors) {}
