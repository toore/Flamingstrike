...
{
    public class MiddleEastViewModelsFactory : TerritoryViewModelsFactoryBase
    {
        public MiddleEastViewModelsFactory(ITerritoryColors territoryColors) : base(territoryColors) {}
        ...
        {
            get { return new Point(720.74384, 223.0227); }
        }
