...
{
    public class SiberiaViewModelsFactory : TerritoryViewModelsFactoryBase
    {
        public SiberiaViewModelsFactory(ITerritoryColors territoryColors) : base(territoryColors) {}
