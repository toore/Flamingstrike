...
namespace RISK.Tests.Gameplay
{
    ...
    public class AlternateGameSetupTests
    {
        ...
        public void Assign_players_to_territories()
        {
            ...
            worldMap.GetTerritory(_location1).AssignedToPlayer.Should().Be(_player1);
            worldMap.GetTerritory(_location2).AssignedToPlayer.Should().Be(_player2);
            worldMap.GetTerritory(_location3).AssignedToPlayer.Should().Be(_player1);
        }
