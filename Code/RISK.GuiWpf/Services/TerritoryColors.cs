...
{
    public class TerritoryColors : ITerritoryColors
    {
        public TerritoryColors(Color normalStrokeColor, Color normalFillColor, Color mouseOverStrokeColor, Color mouseOverFillColor)
        {
