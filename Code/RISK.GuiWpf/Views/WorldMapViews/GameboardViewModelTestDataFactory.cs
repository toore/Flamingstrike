...
namespace GuiWpf.Views.WorldMapViews
{
    public class GameboardViewModelTestDataFactory : IGameInitializerLocationSelector
    {
        ...
        private GameboardViewModel Create()
        {
            ...
            var gameboardViewModel = new GameboardViewModel(game, locations.GetAll(), worldMapViewModelFactory, territoryViewModelUpdater, new FakeGameOverEvaluater(), null, new GameOverViewModelFactory(), new ResourceManagerWrapper(), null, null, null);
